...
/**
 * Lớp Menu đại diện cho menu chính của ứng dụng
 */
public class Menu extends JPanel {
    ...
    // Setter cho trạng thái menuFull
    ...
    // Danh sách sự kiện của menu
    private final List<MenuEvent> events = new ArrayList<>();
    private boolean menuFull = true;
    private final String headerName = "Polo Man";

    // Các thuộc tính thiết lập cho giao diện menu
    ...
    // Phương thức xử lý sự kiện khi menu được chọn
    ...
    // Phương thức chạy sự kiện menu được chọn
    ...
    // Getter và Setter cho các thuộc tính thiết lập giao diện menu
    ...
    private class MenuLayout implements LayoutManager {
        ...
        // Thiết lập vị trí và kích thước cho các thành phần trong menu
        @Override
