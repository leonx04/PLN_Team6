...
public class FormSanPham extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnHuySP.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int rowDC = tblSP.getSelectedRow();
        if (rowDC >= 0) {
            ...
            int option = JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn khôi phục trạng thái kinh doanh sản phẩm này?",
                    "Xác nhận khôi phục kinh doanh", JOptionPane.YES_NO_OPTION);
            if (option == JOptionPane.YES_OPTION) {
                SanPhamModel sp = new SanPhamModel();
                if (sprs.updateActiveTrangThai(sp, ID) > 0) {
                    JOptionPane.showMessageDialog(this, "Đã khôi phục trạng thái thành đã kinh doanh cho sản phẩm!");
                    refreshData();
                    fillTable(sprs.getAllSP());
                    clear();
                } else {
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng chọn một sản phẩm để khôi phục trạng thái");
        }
