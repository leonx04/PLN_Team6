...
public class FormBanHang extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "STT", "Mã Hóa Đơn", "Ngày Tạo", "Nhân viên", "Khách hàng",
                                                "Voucher", "Tổng tiền",
                ...
                tblGioHang.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Mã sản phẩm chi tiết", "Tên sản phẩm", "Đơn giá", "Số lượng",
                                                "Thành tiền", "Chọn"
                                }) {
                ...
                btnSuccesHoaDon.setIcon(
                                new javax.swing.ImageIcon(getClass().getResource("/raven/icon/png/succes.png"))); // NOI18N
                ...
                tblCTSP.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Mã CTSP", "Tên sản phẩm", "Màu sắc", "Size", "Chất liệu",
                                                "Hãng", "Giá bán",
                                                "Số lượng", "Mô tả"
                                }) {
                        boolean[] canEdit = new boolean[] {
        ...
        protected void tblGioHangMouseClicked(MouseEvent evt) {
                ...
                throw new UnsupportedOperationException("Unimplemented method 'tblGioHangMouseClicked'");
        }
