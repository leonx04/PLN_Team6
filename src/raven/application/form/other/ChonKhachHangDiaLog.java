...
public class ChonKhachHangDiaLog extends javax.swing.JDialog {
    ...
    private FormBanHang1 formBanHangPanel;

    /**
     * Creates new form ChonKhachHangDiaLog
     */
    public ChonKhachHangDiaLog(FormBanHang1 formBanHangPanel, boolean modal) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (khrs.checkTrungID(kh.getMa())) {
            JOptionPane.showMessageDialog(this, "Mã khách hàng đã tồn tại không thể thêm.");
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChonKhachHangDiaLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChonKhachHangDiaLog dialog = new ChonKhachHangDiaLog((FormBanHang1) new javax.swing.JPanel(), true);
